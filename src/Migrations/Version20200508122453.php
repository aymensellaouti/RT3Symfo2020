 ...
 */
final class Version20200508122453 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE personne ADD classe_id INT DEFAULT NULL, ADD social_media_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_FCEC9EF8F5EA509 ON personne (classe_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_FCEC9EF8F5EA509 ON personne');
        $this->addSql('DROP INDEX UNIQ_FCEC9EF64AE4959 ON personne');
        $this->addSql('ALTER TABLE personne DROP classe_id, DROP social_media_id');
    }
}
